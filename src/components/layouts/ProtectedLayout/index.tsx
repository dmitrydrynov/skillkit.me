...
import LogoImg from '@assets/images/logo-example.svg'
import Image from 'next/image'
import UserAvatarImg from '@assets/images/user-avatar-example.jpg'
...
const user = {
  ...
  imageUrl: UserAvatarImg.src,
}
const navigation = [
  { name: 'Skills', href: '/work/dashboard', current: true },
...
const userNavigation = [
  ...
  { name: 'Settings', href: '/work/settings' },
  { name: 'Sign out', href: '/' },
]
