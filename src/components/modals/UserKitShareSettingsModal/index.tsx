...
const UserKitShareSettingsModal = ({ onSave, onCancel, userKitId, recordId = null, visible = false }: _ModalParams) => {
...
export default UserKitShareSettingsModal;
